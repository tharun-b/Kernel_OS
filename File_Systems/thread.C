...
static void thread_shutdown() {
	...
	/* calling the terminate and
	 * deleting threads takes place inside*/
...
static void thread_start() {
 ...
 //   if (not(Machine::interrupts_enabled())) Not needed
...
*/
	...
	//Console::puts("Switching ");
	//Console::putui((unsigned int)_thread);

	threads_low_switch_to(_thread);
	//Console::puts("Switched ");
...
/* function just created to get the current stack ecxposed only with this API
 * to delete during deletion of thread.
 */
